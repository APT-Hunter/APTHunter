...
do 
	...
	then
		...
		INPUT_FILE='/home/x10/APTHUNT/PoC/parsers-master/cdm/json/HOLMES/eng3/theia/extracted_events/ta1-theia-e3-official-6r.json.1/forward.csv'
	fi
	if [ $i -eq 2 ]
	then		
		INPUT_FILE='/home/x10/APTHUNT/PoC/parsers-master/cdm/json/HOLMES/eng3/theia/extracted_events/ta1-theia-e3-official-6r.json.2/forward.csv'
	fi	
	if [ $i -eq 3 ]
	then		
		INPUT_FILE='/home/x10/APTHUNT/PoC/parsers-master/cdm/json/HOLMES/eng3/theia/extracted_events/ta1-theia-e3-official-6r.json.3/forward.csv'
	fi
	if [ $i -eq 4 ]
	then		
		INPUT_FILE='/home/x10/APTHUNT/PoC/parsers-master/cdm/json/HOLMES/eng3/theia/extracted_events/ta1-theia-e3-official-6r.json.4/forward.csv'
	fi
	if [ $i -eq 5 ]
	then		
		INPUT_FILE='/home/x10/APTHUNT/PoC/parsers-master/cdm/json/HOLMES/eng3/theia/extracted_events/ta1-theia-e3-official-6r.json.5/forward.csv'
	fi
	if [ $i -eq 6 ]
	then		
		INPUT_FILE='/home/x10/APTHUNT/PoC/parsers-master/cdm/json/HOLMES/eng3/theia/extracted_events/ta1-theia-e3-official-6r.json.6/forward.csv'
	fi
	if [ $i -eq 7 ]
	then		
		INPUT_FILE='/home/x10/APTHUNT/PoC/parsers-master/cdm/json/HOLMES/eng3/theia/extracted_events/ta1-theia-e3-official-6r.json.7/forward.csv'

	fi
	if [ $i -eq 8 ]
	then		
		INPUT_FILE='/home/x10/APTHUNT/PoC/parsers-master/cdm/json/HOLMES/eng3/theia/extracted_events/ta1-theia-e3-official-6r.json.8/forward.csv'

	fi
	if [ $i -eq 9 ]
	then		
		INPUT_FILE='/home/x10/APTHUNT/PoC/parsers-master/cdm/json/HOLMES/eng3/theia/extracted_events/ta1-theia-e3-official-6r.json.9/forward.csv'
