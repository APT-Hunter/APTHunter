...
fileList = ['ta1-trace-2-e5-official-1.bin.55.json', 'ta1-trace-2-e5-official-1.bin.53.json', 'ta1-trace-2-e5-official-1.bin.53.json.1',
'ta1-trace-2-e5-official-1.bin.54.json', 'ta1-trace-2-e5-official-1.bin.54.json.1']
...
### 1- Extract Subjects and Objects per log file#######
###################################################
