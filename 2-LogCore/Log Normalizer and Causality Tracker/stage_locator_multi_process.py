			...
			with open('/home/elasticsearch/TC-DAS/ta3-java-consumer/tc-bbn-kafka/' + log_file) as jsondata:		    
				for line in reversed(list(jsondata)):
					...
					if (cdm_record_type == "com.bbn.tc.schema.avro.cdm20.Event"):	
						...
						if not (event_type == "EVENT_WRITE" or event_type == "EVENT_EXECUTE" or event_type == "EVENT_READ" or event_type == "EVENT_FORK" or event_type == "EVENT_ACCEPT" or event_type == "EVENT_CONNECT" or event_type == "EVENT_MODIFY_PROCESS" or event_type == "EVENT_LOADLIBRARY" or event_type == "EVENT_CHANGE_PRINCIPAL" or event_type == "EVENT_MMAP"):
							continue
