...
##### Working on backwards.csv ##############
		INPUT_FILE='/home/x10/APTHUNT/PoC/parsers-master/cdm/json/theia/extracted_events/ta1-theia-1-e5-official-2.bin.'$i'.json'$j'/backwards.csv'
		PROOF_FILE='/home/x10/APTHUNT/PoC/parsers-master/cdm/json/theia/extraction_proof/ta1-theia-1-e5-official-2.bin.'$i'.json'$j
...
##### Working on forward.csv ##############
		INPUT_FILE='/home/x10/APTHUNT/PoC/parsers-master/cdm/json/theia/extracted_events/ta1-theia-1-e5-official-2.bin.'$i'.json'$j'/forward.csv'
		PROOF_FILE='/home/x10/APTHUNT/PoC/parsers-master/cdm/json/theia/extraction_proof/ta1-theia-1-e5-official-2.bin.'$i'.json'$j
		echo "working on " $INPUT_FILE
		while [ ! -f $PROOF_FILE ] ;
		do
	...
	#### confirming consuming the events
		echo "Done: ta1-theia-1-e5-official-2.bin."$i".json"
		touch ./consumed_events/ta1-theia-1-e5-official-2.bin.$i.json$j
